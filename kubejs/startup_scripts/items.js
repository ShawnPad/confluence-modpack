...
StartupEvents.registry('block', event => {
  event.create('mercury_ore').displayName('Mercury Ore')
    ...
    .drops(() => Java.loadClass('dev.latvian.mods.kubejs.block.drop.BlockDrops').createDefault(Item.of('kubejs:mercury_shard', 1)))
  event.create('glacio_ore').displayName('Glacio Ore')
    .hardness(3).resistance(3).requiresTool()
    .tagBlock('minecraft:mineable/pickaxe').tagBlock('minecraft:needs_diamond_tool')
    .drops(() => Java.loadClass('dev.latvian.mods.kubejs.block.drop.BlockDrops').createDefault(Item.of('kubejs:glacio_shard', 1)))
})
